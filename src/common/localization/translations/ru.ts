export const ru = {
  translation: {
    ...
    authUnavailable: 'Авторизация в данный момент недоступна',
    warning: 'Внимание',
    attention: 'Внимание',
    syncWithServer: 'Быстрая синхр. с сервером',
    uploadToGoogle: 'Загрузить все в Google',
    getFromGoogle: 'Пулучить из Google',
    notificAfterChangeAcc: 'Вы можете выполнить синхронизацию или загрузить ваши данный другим удобным для вам способом!',
    warningChangeAcc: 'Вы сменили аккаунт. Если вы продолжите, все данные, хранящиеся локально, будут удалены. Рекомендуем все сохранить!',
  },
};
